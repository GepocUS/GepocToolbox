...
function sys = Reactors_gen_ss(p, x0, u0)
    ...
    d_xAR_xA3_0 = -(p.alphaA - p.alphaC)*p.alphaA*xA3_0/(den_AR_0^2) + (p.alphaA^2*xA3_0)/den_AR_0;
    d_xAR_xB3_0 = -(p.alphaB - p.alphaC)*p.alphaA*xA3_0/(den_AR_0^2);
    d_xBR_xA3_0 = -(p.alphaA - p.alphaC)*p.alphaB*xB3_0/(den_AR_0^2);
    d_xBR_xB3_0 = -(p.alphaB - p.alphaC)*p.alphaB*xB3_0/(den_AR_0^2) + (p.alphaB^2*xB3_0)/den_AR_0;
